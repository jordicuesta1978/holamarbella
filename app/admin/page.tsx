...
async function getDashboardData() {
  ...
  const [pending, llegadas, ultimasReservas, proximasLlegadas] = await Promise.all([
...
export default async function AdminPage() {
  const { stats, ultimasReservas, proximasLlegadas } = await getDashboardData()

  const cards = [
    { icon: Clock, label: 'Reservas', sub: 'Pendientes de gestión', value: stats.pending, href: '/admin/reservas?status=pending' },
    { icon: CalendarCheck, label: 'Llegadas', sub: 'Esta semana', value: stats.llegadas, href: '/admin/calendario' },
  ]
