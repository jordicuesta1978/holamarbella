...
import { getApartment, getPhotos } from '@/lib/apartments';
import {
...
export default function ApartamentoPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const photos = apartment ? getPhotos(slug, apartment.photoCount) : [];
    ...
    return (
      <div style={{ backgroundColor: 'var(--surface)' }}>
        ...
        <div className="max-w-7xl mx-auto px-8 py-32 text-center">
          <p className="text-xl" style={{ color: 'var(--on-surface-variant)' }}>Apartamento no encontrado.</p>
  ...
  return (
    <div style={{ backgroundColor: 'var(--surface)', color: 'var(--on-surface)' }}>
      ...
      <div className="relative">
        ...
        <div className="hidden md:grid md:grid-cols-[3fr_2fr] gap-2 h-[520px] max-w-7xl mx-auto px-8 py-6">
          <button
            ...
            className="rounded-2xl overflow-hidden block h-full group"
          >
            <img
              src={photos[0]}
              alt={apartment.title}
        ...
        <div>
          ...
          <div className="py-8 border-b" style={{ borderColor: 'var(--outline-variant)' }}>
            ...
            <div
              ...
              style={{ height: 280, backgroundColor: 'var(--arena)', border: '1px solid var(--outline-variant)' }}
            >
          ...
          <div className="sticky top-24 rounded-2xl border shadow-xl p-6" style={{ borderColor: 'var(--outline-variant)', backgroundColor: 'white' }}>
            ...
            <div className="border rounded-xl p-3 mb-4" style={{ borderColor: 'var(--outline-variant)' }}>
              ...
              <select
                ...
                className="w-full text-sm focus:outline-none bg-transparent cursor-pointer"
                style={{ color: 'var(--on-surface)' }}
              >
            ...
            <p className="text-xs text-center mt-3" style={{ color: 'var(--on-surface-variant)' }}>
              ...
              Tu solicitud será revisada por Mar.
            </p>
          </div>
        </div>
      </div>
      ...
      {/* ── MOBILE BOTTOM BAR ─────────────────────────────────────── */}
      <div
        className="lg:hidden fixed bottom-0 left-0 right-0 z-40 border-t flex items-center justify-between px-5 py-3"
        style={{ backgroundColor: 'white', borderColor: 'var(--outline-variant)', boxShadow: '0 -4px 20px rgba(0,0,0,0.08)' }}
      >
        <div>
        ...
        <Link
          href={`/reservar/${apartment.slug}`}
          className="text-white font-bold text-sm px-6 py-3 rounded-full uppercase tracking-widest transition-opacity hover:opacity-90"
          style={{ backgroundColor: 'var(--primary)' }}
        >
          Solicitar reserva
        </Link>
      ...
      {lightboxOpen && (
        ...
        >
          ...
          <button
            onClick={closeLightbox}
            className="absolute top-4 right-4 text-white p-2 rounded-full transition-colors hover:bg-white/20"
            aria-label="Cerrar"
          >
            <X size={24} />
          </button>
          ...
          <button
            ...
            className="absolute left-4 text-white p-3 rounded-full transition-colors hover:bg-white/20"
          ...
          <img
            ...
            alt={`${apartment.title} ${lightboxIndex + 1}`}
          ...
          <button
            ...
            className="absolute right-4 text-white p-3 rounded-full transition-colors hover:bg-white/20"
          ...
          <div className="absolute bottom-4 left-1/2 -translate-x-1/2 flex gap-1.5 overflow-x-auto max-w-[90vw] px-2">
            {photos.map((src, i) => (
              <button
                ...
                className={`shrink-0 rounded-md overflow-hidden transition-all ${i === lightboxIndex ? 'ring-2 ring-white' : 'opacity-50 hover:opacity-80'}`}
      ...
      {amenitiesOpen && (
        ...
        >
          <div
            className="relative w-full max-w-2xl my-8 mx-4 rounded-2xl p-8 shadow-2xl"
                ...
                return (
                  <div key={label}>
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <h3 className="font-bold text-sm uppercase tracking-widest" style={{ color: 'var(--on-surface)' }}>
                        {label}
                      </h3>
                    </div>
